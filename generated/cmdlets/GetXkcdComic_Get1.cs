namespace Sample.API.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] xkcd_getComic=>GET:"/{comicId}/info.0.json"
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"XkcdComic_Get1")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IComic))]
    [Sample.API.Description(@"Fetch comics and metadata  by comic id.\n")]
    [Sample.API.Generated]
    public partial class GetXkcdComic_Get1 : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ComicId" /> property.</summary>
        private float _comicId;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "HELP MESSAGE MISSING")]
        [Sample.API.Category(Sample.API.ParameterCategory.Path)]
        public float ComicId { get => this._comicId; set => this._comicId = value; }
        ...
        /// <summary>Intializes a new instance of the <see cref="GetXkcdComic_Get1" /> cmdlet class.</summary>
        public GetXkcdComic_Get1()
        {
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.XkcdGetComic(ComicId, onOk, this, Pipeline);
